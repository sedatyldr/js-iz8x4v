...
const discounter = (price, discount) => {
...
for (let i = 0; i < products.length; i++) {
  pcont += `<div class="product">
    <h2 class="title">${products[i].title}</h2>
    <img class="image" src="${products[i].thumbnail}"/>
    <p class="price">${products[i].price} $</p>
    <p class="discount-price">${discounter(
      products[i].price,
      products[i].discountPercentage
    )} $</p>
    <p class="description">${products[i].description} </p>
    <p class="rating">${products[i].rating} </p>
    <p class="stock">${stockControl(products[i].stock)} </p>
    <button class="addToCart" data-id="${products[i].id}">Sepete Ekle</button>
  </div><br>`;
}
